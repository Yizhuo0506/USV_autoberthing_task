...
from omniisaacgymenvs.tasks.USV.USV_2D_thruster_generator import (
    VirtualPlatform,
)
from omniisaacgymenvs.tasks.USV.USV_2D_task_factory import (
    task_factory,
)
from omniisaacgymenvs.tasks.USV.USV_2D_core import parse_data_dict
...
class USV2DVirtual(RLTask):
    ...
    def __init__(
        ...
        self.water_density=self._task_cfg["dynamics"]["buoyancy"]["water_density"] # kg/m^3
