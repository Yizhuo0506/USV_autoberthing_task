...
from omniisaacgymenvs.robots.articulations.USV_3D_virtual_thrusters import (
    ModularFloatingPlatform,
)
from omniisaacgymenvs.robots.articulations.views.USV_3d_virtual_thrusters_view import (
    ModularFloatingPlatformView,
)

from omniisaacgymenvs.tasks.USV.USV_3D_thruster_generator import (
    VirtualPlatform,
)
from omniisaacgymenvs.tasks.USV.USV_3D_task_factory import (
    task_factory,
)
...
from omniisaacgymenvs.tasks.USV.USV_3D_disturbances import (
...
class USV3DVirtual(USV2DVirtual):
    """
